...
export const metadata: Metadata = {
  ...
  description:
    "Expert aluminium window installation in Johannesburg. SABS certified, 10-year guarantee. Serving all Johannesburg suburbs. Free quotes - Call 060 269 1601",
  keywords: [
