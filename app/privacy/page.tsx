          ...
          <div className="max-w-3xl mx-auto prose prose-slate prose-lg">
            ...
            <div className="mb-10">
              ...
              <div className="mt-4 bg-slate-50 rounded-lg p-4 border border-slate-200">
                ...
                <p className="text-slate-700 text-sm mt-1"><strong>Phone:</strong> 060 269 1601</p>
            ...
            <div className="mb-10">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border border-slate-200 space-y-3">
                ...
                <a href="tel:+27602691601" className="flex items-center gap-3 text-slate-700 hover:text-blue-600 transition-colors">
