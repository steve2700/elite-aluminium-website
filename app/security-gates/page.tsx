...
export const metadata: Metadata = {
  ...
  description:
    "Premium security gates and burglar bars in Gauteng. Expert installation for maximum protection. SABS approved. 10-year guarantee. Call 060 269 1601.",
  keywords:
