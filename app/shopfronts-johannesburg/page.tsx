...
export const metadata: Metadata = {
  ...
  description:
    "Professional shopfront installers in Johannesburg. Custom aluminium & glass shopfronts, automatic doors, 24/7 repair service. 15+ years experience. Free quote.",
  keywords:
    "shopfront installers johannesburg, shopfront installation, aluminium shopfronts johannesburg, glass shopfronts, commercial glazing, retail shopfronts",
  openGraph: {
    title: "Shopfront Installers Johannesburg | Expert Aluminium & Glass",
    description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: "Shopfront Installers Johannesburg",
            description:
              "Professional shopfront installation, repair and maintenance in Johannesburg with 15+ years experience",
            provider: {
              "@type": "LocalBusiness",
            ...
            serviceType: "Shopfront Installation",
          }),
        }}
      />
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-4 bg-blue-600 hover:bg-blue-700">Specialists</Badge>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-balance">
              Shopfront Installers Johannesburg
            </h1>
            <p className="text-xl md:text-2xl text-slate-200 mb-8 text-pretty">
              Professional shopfront installation in Johannesburg. Custom aluminium & glass shopfronts,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
               Shopfront Services in Johannesburg
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link href="/security-gates-sandton" className="text-blue-600 hover:underline text-sm">
                Security Solutions
              </Link>
