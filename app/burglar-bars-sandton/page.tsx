...
export const metadata: Metadata = {
  ...
  description:
    "Premium burglar bars in Sandton. Estate-approved designs, SABS certified, custom finishes. From R250/m. Call 060 269 1601.",
  keywords: [
      ...
      <section className="relative bg-gradient-to-br from-slate-900 to-slate-800 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-4">
            ...
            <Link href="https://wa.me/27602691601?text=Hi%2C%20I%27d%20like%20a%20premium%20quote%20for%20burglar%20bars%20in%20Sandton">
