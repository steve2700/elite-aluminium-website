...
export const metadata: Metadata = {
  ...
  description:
    "Premium powder-coated aluminium fencing in Johannesburg. Estate-approved, SABS certified, 10-year guarantee. Serving all JHB suburbs. Free quotes - Call 060 269 1601",
  keywords: [
    ...
    <>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <a href="tel:+27602691601" className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
              <Phone className="h-5 w-5" /> 060 269 1601
            </a>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4 md:hidden z-50">
        <div className="flex gap-2">
          ...
          <a href="https://wa.me/27602691601?text=Hi%2C%20I%27d%20like%20a%20quote%20for%20aluminium%20fencing%20in%20Johannesburg" target="_blank" rel="noopener noreferrer" className="flex-1 bg-green-600 text-white text-center py-3 rounded-lg font-semibold">💬 WhatsApp</a>
        </div>
      </div>
    </>
  )
