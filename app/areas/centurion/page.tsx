...
export const metadata: Metadata = {
  ...
  description: "Elite Aluminium serves Centurion with aluminium windows, fencing, carports and estate-approved security solutions. SABS certified. Free quotes - Call 060 269 1601",
...
export default function CenturionAreaPage() {
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "LocalBusiness", name: "Elite Aluminium - Centurion", "@id": "https://www.elitealuminium.co.za/areas/centurion", url: "https://www.elitealuminium.co.za/areas/centurion", telephone: "+27602691601", email: "info@elitealuminium.co.za", address: { "@type": "PostalAddress", addressLocality: "Centurion", addressRegion: "Gauteng", addressCountry: "ZA" }, geo: { "@type": "GeoCoordinates", latitude: -25.8619, longitude: 28.1881 }, areaServed: { "@type": "City", name: "Centurion" } }) }} />
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4 md:hidden z-50">
        <div className="flex gap-2">
          ...
          <a href="https://wa.me/27602691601?text=Hi%2C%20I%27d%20like%20a%20quote%20in%20Centurion" target="_blank" rel="noopener noreferrer" className="flex-1 bg-green-600 text-white text-center py-3 rounded-lg font-semibold">💬 WhatsApp</a>
        </div>
      </div>
    </>
  )
