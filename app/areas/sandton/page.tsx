...
export const metadata: Metadata = {
  ...
  description:
    "Elite Aluminium serves all of Sandton with premium aluminium windows, doors, security gates, burglar bars, glass balustrades & more. SABS certified. Free quotes - Call 079 593 5025",
  keywords: [
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        url: "https://elitealuminium.co.za/areas/sandton", telephone: "+27795935025",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/27795935025?text=Hi%2C%20I%27d%20like%20a%20quote%20for%20services%20in%20Sandton" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4 md:hidden z-50">
        <div className="flex gap-2">
          ...
          <a href="https://wa.me/27795935025?text=Hi%2C%20I%27d%20like%20a%20quote%20in%20Sandton" target="_blank" rel="noopener noreferrer" className="flex-1 bg-green-600 text-white text-center py-3 rounded-lg font-semibold">💬 WhatsApp</a>
        </div>
      </div>
    </>
  )
