...
export const metadata: Metadata = {
  ...
  description:
    "Frameless, semi-frameless and framed shower doors in Johannesburg. Professional installation, SABS certified. Serving all JHB suburbs. Free quotes - Call 060 269 1601",
  keywords: [
    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4 md:hidden z-50">
        <div className="flex gap-2">
          ...
          <a href="https://wa.me/27602691601?text=Hi%2C%20I%27d%20like%20a%20quote%20for%20shower%20doors%20in%20Johannesburg" target="_blank" rel="noopener noreferrer" className="flex-1 bg-green-600 text-white text-center py-3 rounded-lg font-semibold">💬 WhatsApp</a>
        </div>
      </div>
    </>
  )
