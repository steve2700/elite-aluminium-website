...
export const metadata: Metadata = {
  ...
  description:
    "Premium aluminium sliding doors in Gauteng. Space-saving, elegant designs with expert installation. 10-year guarantee. Free quotes. Call 060 269 1601 today.",
  keywords:
