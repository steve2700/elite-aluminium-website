...
export const metadata: Metadata = {
  ...
  description:
    "Professional sliding door installation in Johannesburg. Stacking doors, lift-slide, pocket doors. 10-year guarantee. Call 060 269 1601.",
  keywords:
        ...
        <div className="container mx-auto px-4 py-20 lg:py-28 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                href="https://wa.me/27602691601?text=Hi%2C%20I%27d%20like%20a%20quote%20for%20sliding%20doors%20in%20Johannesburg"
                target="_blank"
